...
export function AdSensePlaceholder() {
    ...
    return (
        ...
        >
            ...
            <div className="md:hidden w-[300px] min-h-[250px] bg-[#0f0f12] rounded-xl relative overflow-hidden flex flex-col items-center justify-center group">
            ...
            <div className="hidden md:flex w-[728px] max-w-full min-h-[90px] bg-[#0f0f12] relative overflow-hidden flex-col items-center justify-center rounded-xl group">
                {/* Empty container ready for AdSense injection */}
