        ...
        <section className="w-full py-6 z-20 relative -mt-[66px]">
            <div className="w-full max-w-none px-4 sm:max-w-[1050px] sm:mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="relative group rounded-[4px] bg-[#121212]/80 backdrop-blur-sm border border-[#7d3cff]/45 px-6 pt-6 pb-6 shadow-xl transition-all h-full min-h-[290px]">
                    ...
                    <div className="relative group rounded-[4px] bg-[#121212]/80 backdrop-blur-sm border border-[#7d3cff]/45 px-6 pt-6 pb-6 shadow-xl transition-all h-full min-h-[290px] flex flex-col justify-between">
                        <div className="flex gap-4">
                            {/* Left Column: Icon */}
                            <div className="flex-shrink-0 pt-1">
