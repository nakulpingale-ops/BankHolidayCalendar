...
export function LearnGuides() {
    return (
        <section className="mb-12 bg-gradient-to-br from-[#7d3cff]/10 to-transparent border border-[#7d3cff]/20 rounded-[4px] p-6 print:hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <Link
                    ...
                    className="flex-1 bg-black/20 hover:bg-[#7d3cff]/20 border border-white/10 hover:border-[#7d3cff]/30 p-4 rounded-[4px] transition-all group"
                >
