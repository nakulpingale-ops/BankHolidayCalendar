    ...
    return (
        <main className="w-full max-w-[800px] mx-auto px-4 pt-[93px] pb-12 text-gray-300">
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">General Information</h2>
                <p>
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">Not Professional Advice</h2>
                <p>
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">Government Data Changes</h2>
                <p>
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">Limitation of Liability</h2>
                <p>
