    ...
    return (
        <main className="w-full max-w-[800px] mx-auto px-4 py-12 text-gray-300">
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">1. Acceptance of Terms</h2>
                <p>
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">2. Use License</h2>
                <p>
                ...
                <ul className="list-disc pl-5 space-y-1 marker:text-[#7d3cff]">
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">3. Disclaimer</h2>
                <p>
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">4. Accuracy of Materials</h2>
                <p>
