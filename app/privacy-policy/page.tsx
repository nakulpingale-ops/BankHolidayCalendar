...
export default function PrivacyPolicyPage() {
    return (
        <main className="w-full max-w-[800px] mx-auto px-4 py-12 text-gray-300">
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">Log Files</h2>
                <p>
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">Cookies and Web Beacons</h2>
                <p>
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">Google DoubleClick DART Cookie</h2>
                <p>
                    Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL – <a href="https://policies.google.com/technologies/ads" className="text-[#7d3cff] hover:underline" rel="nofollow noopener" target="_blank">https://policies.google.com/technologies/ads</a>
                </p>
            </section>

            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">Privacy Policies of Third Party Advertisers</h2>
                <p>
            ...
            <section className="mb-8 space-y-4">
                <h2 className="text-xl font-bold text-[#7d3cff]">Consent</h2>
                <p>
